...
!function($) {
    ...
    $('.video-wrap iframe').wrap('<div class="embed-responsive embed-responsive-16by9"></div>');
    $('.video-wrap embed').wrap('<div class="embed-responsive embed-responsive-16by9"></div>');
...
jQuery('.menu-xs-arrow').on('click', function (e) {
...
(function($) {
    ...
    $(window).scroll(function() {    
        ...
        if (scroll >= 50) {
            $("#topnav").addClass("headertop");
        } else {
            $("#topnav").removeClass("headertop");
        }
    });
})(jQuery);
